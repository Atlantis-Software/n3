...
function fromCharset(charset, buffer, keep_buffer) {
    var sourceString = Iconv.decode(buffer, charset);
    var utf8Buffer = Iconv.encode(sourceString, 'utf-8');
    return keep_buffer ? utf8Buffer : buffer.toString('utf-8');
}
...
function toCharset(charset, buffer) {
    var charsetString = Iconv.decode(buffer, charset);
    var charsetBuffer = Iconv.encode(charsetString, charset);
    return charsetBuffer;
}
